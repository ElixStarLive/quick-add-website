...
(function () {
  var ICON = {
    ...
    clean: 'M12 2c-.55 0-1 .45-1 1v1H8c-.55 0-1 .45-1 1v2c0 .55.45 1 1 1h1v10c0 1.1.9 2 2 2h4c1.1 0 2-.9 2-2V7h1c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1h-3V3c0-.55-.45-1-1-1z',
    ...
    build: 'M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3z',
    roof: 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z',
    window: 'M4 6h16v2H4V6zm0 5h16v2H4v-2zm0 5h16v2H4v-2z',
    ...
    floor: 'M3 5h18v2H3V5zm0 6h18v2H3v-2zm0 6h18v2H3v-2z',
  ...
  function renderServiceCategories(containerId) {
    ...
    GROUPS.forEach(function (g) {
      ...
      html += '<div class="job-icons-section job-icons-section--' + esc(g.work) + '"><div class="job-icons-grid">';
